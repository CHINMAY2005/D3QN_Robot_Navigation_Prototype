...
export default function AppPrototype({ onViewModeChange }) {
  ...
  }, [obstacles, showLidar, selectedRobotIndex, isDrawingMode, drawingStart, drawingCurrent, showPotentialField, showHeatmap, densityGrid, collisionHistory, cooperativeNavigation, selectedReplayPath, replayScrubberIndex]);
  ...
  }, [robots, robotsB, obstacles, drawScene, activeTab, showPotentialField, showHeatmap, densityGrid, collisionHistory, cooperativeNavigation, selectedReplayPath, replayScrubberIndex]);
